...
urlpatterns = [
    ...
    path(
        "spotify/profile/",
        views.get_user_spotify_profile,
        name="spotify_profile",
    ),
    path(
        "spotify/fetch-profile/",
        views.fetch_spotify_profile,
        name="fetch_spotify_profile",
    ),
    # Additional ProfileView Endpoints (if needed)
    path("profile/view/", views.ProfileView.as_view(), name="profile_view"),
    path(
        "profile/create/", views.ProfileView.as_view(), name="create_profile"
    ),
]
