...
urlpatterns = [
    ...
    path("info-requests/", InfoRequestListCreateView.as_view(), name="info-request-list-create"),
    path("info-requests/<int:pk>/<str:action>/", InfoRequestActionView.as_view(), name="info-request-action"),
