...
const AppearanceSchema: Schema = new Schema({
    ...
    bodyType: {
        type: String,
        trim: true,
        maxlength: [50, 'Body type description cannot exceed 50 characters']
    },
    hairColor: {
        type: String,
        trim: true,
...
const profileSchema: Schema = new Schema({
    ...
    criteria: {
        ...
        // Add other criteria fields with similar validations as needed
    },
    spotifyInfo: {
        topArtists: {
            type: [String],
        ...
        currentPlayback: {
            type: String,
            trim: true,
            maxlength: [200, 'Current playback information cannot exceed 200 characters']
        }
    },
    favoriteMovies: {
        type: [String],
    ...
    profession: {
        type: String,
        trim: true,
        maxlength: [100, 'Profession description cannot exceed 100 characters'],
        default: ''
    },
    education: {
        type: String,
        trim: true,
        maxlength: [100, 'Education description cannot exceed 100 characters'],
        default: ''
    },
    privacySettings: {
